...
<div class="row row-sm">
 ...
 <!-- Perulangan do-while, digunakan bila jumlah perulangannya belum diketahui. -->
<?php  
$i = 1;
...
?>  
<!-- Pada badan perulangan do-while, dapat berisi statement tunggal atau banyak statement. -->
</body>
</html>